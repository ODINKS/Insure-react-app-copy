    ...
    return (
        <>
            <form action="" className='border border-0 grid grid-cols-1 gap-y-6 justify-center md:grid-cols-2 md:gap-x-8 lg:gap-x-14 lg:px-12 px-8 pt-10 pb-14 bg-[--white-bg]'>
                <h1 className='text-center font-bold text-[1.5rem] col-span-2'>Account Settings</h1>
                {/* Input elements */}
                <input type="email" name="" id="" placeholder='Change email' className='border border-[--form-border-bg] w-72 md:w-96 lg:w-auto px-3 py-2 md:text-xl rounded-md focus:border-[--blue-bg] focus:outline-none md:h-[3.625rem]' />
                ...
                <input type="text" name="" id="" placeholder='Location' className='border border-[--form-border-bg] w-72 md:w-96 lg:w-auto px-3 py-2 md:h-[3.625rem] md:text-xl rounded-md focus:border-[--blue-bg] focus:outline-none' />
