...
const DropDownMenu = ({data}) => {
  ...
  return (
    ...
    <div className="flex-none">
        <button onClick={showDropdownOptions} className="flex flex-row justify-between px-2 py-2 text-gray-700 bg-orange-500 rounded-md focus:outline-none focus:border-blue-600">
        ...
        <div id="options" className="hidden py-2  bg-white rounded-lg shadow-xl">
