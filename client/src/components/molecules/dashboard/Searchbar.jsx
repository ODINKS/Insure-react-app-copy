...
const Searchbar = () => {
    return (
        <>
            <form className='flex flex-col  lg:flex-row lg:flex-wrap lg:justify-between w-full items-center gap-10 border border-0 rounded-md bg-[--white-bg] mt-5 px-10 py-5 mb-5'>
                {/* Search bar */}
