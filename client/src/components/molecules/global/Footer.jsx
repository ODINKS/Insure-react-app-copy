        ...
        <div className='bg-[--black-bg]'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 lg:flex lg:justify-between gap-10 pt-10 text-[--white-text] bg-[--black-bg] lg:px-12 px-12 pb-14 lg:absolute lg:top-[6rem] lg:pt-[9rem] lg:left-0 lg:right-0'>
            <div className='flex flex-col justify-center items-center lg:items-start gap-5 lg:mt-10'>
              ...
              <p className='w-[20rem] text-left text-[1.1rem]'>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Sit illo et delectus modi fugiat sed explicabo. Doloremque reiciendis ex, explicabo voluptate ratione.</p>
            </div>

            <div className='flex flex-col gap-4 items-center lg:items-start justify-start lg:mt-14'>
              <h1 className='text-[1.5rem] font-bold border border-0 border-b-4 border-[--orange-bg] pb-2'>Quick Links</h1>
            ...
            <div className='flex flex-col gap-5 items-center lg:items-start justify-start lg:mt-14'>
              ...
              <ul className='flex gap-5 w-[20rem] text-[1.1rem] mr-10'>
                <li className='border border-white px-5 rounded-lg font-thin'>Download on <span className='font-bold'>App Store</span></li>
                <li className='border border-white px-5 rounded-lg font-thin'>Download on <span className='font-bold'>Google Play</span></li>
              </ul>
            </div>
          </div>
