  ...
  return (
    <div>
      <nav
        ...
        id="navbar"
      >
        <div class="flex flex-wrap items-center justify-between mx-auto p-0 w-[90%]">
          <img
            id="myImage"
          ...
          >
            <div>
              <ul class="flex flex-col lg:items-center font-medium p-4 md:p-0 mt-4 md:flex-row md:space-x-8 md:mt-0 md:mr-0 lg:mr-22">
                <li>
                  <Link
                    to="/"
