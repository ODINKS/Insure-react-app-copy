      ...
      <div>
        ...
        <main className="m-0 p-0 font-lato font-[400]">
          ...
          <section className="bg-blue-200 text-black md:flex flex-row  py-6 font-lato ">
            <div className="container mx-auto  space-y-4 sm:flex-row  md:space-x-8 ">
              {/* Box 1 */}
                ...
                <div className="h-1/5 bg-blue-200 rounded-tr-full rounded-br-full w-64 text- pt-2 px-2 ">
                  ...
                  <div className="flex flex-row px-4">
                    <div className="flex items-center">
                      ...
                      <p className="text-4xl font-bold px-2 mb-4">25.67</p>
                      <p className="text-sm mt-4 mb-6">/Monthly</p>
                    </div>
                  </div>
                </div>
                <div className="h-1/5 p-10">
                  <ul className="list-disc ml-6 ">
                    <p>
                      ...
                      Unlimited access Admin and Agent features.{" "}
                    </p>
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      fill="none"
                    ...
                    Unlimited access to Customer Relationship Management. <br />
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      fill="none"
                      viewBox="0 0 24 24"
                    ...
                    Unlimited access Sales Management. <br />
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      fill="none"
                      viewBox="0 0 24 24"
                    ...
                    Unlimited access to Lead and opportunity tracking <br />
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      fill="none"
                      viewBox="0 0 24 24"
                    ...
                    10 Agents registration access with all benefits.
                    <br /> <br /> <br /> <br /> <br />
                  </ul>
                ...
                <div className="h-1/5 bg-blue-200 rounded-tr-full rounded-br-full w-64 text- pt-2 px-2">
                  ...
                  <div className="flex flex-row px-4">
                    <div className="flex items-center">
                      ...
                      <p className="text-4xl font-bold px-2 mb-4">65.49</p>
                      <p className="text-sm mt-4 mb-6">/Monthly</p>
                    </div>
                  </div>
                </div>
                <div className="h-1/5 p-10">
                  <ul className="list-disc ml-6 ">
                    <p>
                      ...
                      Every benefits available in the Standard plan.{" "}
                    </p>
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      fill="none"
                    ...
                    Data exports for all messages <br />
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      fill="none"
                      viewBox="0 0 24 24"
                    ...
                    Add your own branding to the admin and agent dashboard.
                    <br />
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      fill="none"
                    ...
                    Free access to INsure’s highly customizable profile. <br />
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      fill="none"
                      viewBox="0 0 24 24"
                ...
                <div className="h-1/5 p-10">
                  <ul className="list-disc ml-6 ">
                    <p>
                      ...
                      Every benefits available in the pro plan.{" "}
                    </p>
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      fill="none"
                    ...
                    Support for data loss prevention (DLP), e-discovery and
                    offline backup providers. <br />
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      fill="none"
                      viewBox="0 0 24 24"
                    ...
                    Unlimited Agents registration access with all benefits.
                    <br />
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      fill="none"
