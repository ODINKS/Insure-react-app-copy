    ...
    <main className="bg-[#f4f4f4] w-full h-screen">
      ...
      <div className="grid grid-cols-5 grid-rows-5 gap-4 w-[80%] h-[90vh] p-5 absolute top-[60px] right-0">
        ...
        <div className="flex justify-between w-[1000px] border-b-4 border-bg-[#000] pb-3 py-3 px-7">
          <p className='max-w-[80%]'>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Facere deleniti excepturi cumque quo beatae tempore error? </p>

        <div className='flex items-center bg-[#e76927] w-max text-white rounded-md px-5'>  <Button  description='Action' width='max'/> <VscTriangleDown />
        </div> 
