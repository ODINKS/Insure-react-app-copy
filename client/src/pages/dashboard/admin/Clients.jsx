        ...
        <table className = {tableStyle}>
          <thead>
            <tr>
              ...
              <th className={tableHeadingStyle}>Client Name</th>
          ...
          <tbody>
            <tr>
              ...
              <td className={tableRowStyle}>Leo Austin</td>
            ...
            <tr>
              ...
              <td className={tableRowStyle}>2 years</td>
              <td className={tableRowStyle}>100,000</td>
              <td className={tableRowStyle}>Prince Kanayo</td>
              <td className={tableRowStyle}>PIP</td>
              {renderActionButton(0)}
            </tr>
            <tr>
              ...
              <td className={tableRowStyle}>2 years</td>
              <td className={tableRowStyle}>100,000</td>
              <td className={tableRowStyle}>Nicholas Ese</td>
              <td className={tableRowStyle}>PIP</td>
              {renderActionButton(0)}
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td className={tableRowStyle}>2 years</td>
              <td className={tableRowStyle}>100,000</td>
              <td className={tableRowStyle}>Divine Adepoju</td>
              <td className={tableRowStyle}>PIP</td>
              {renderActionButton(0)}
            </tr>
          </tbody>
